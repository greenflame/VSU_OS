...
static struct fuse_operations myfs_filesystem_operations = {
    .getattr = myfs_getattr, /* To provide size, permissions, etc. */
    .open    = myfs_open,    /* To enforce read-only access.       */
    .read    = myfs_read,    /* To provide file content.           */
    .readdir = myfs_readdir, /* To provide directory listing.      */
};
